...
export function copyForLanguage(language?: string) {
  const en = {
    ...
    accounts: { title: "Accounts", description: "Manage Codex sessions, quotas, and switching.", empty: "No saved Codex accounts yet.", profileUpdated: "Profile updated" },
    ...
    settings: {
      ...
      codex: "Codex", executable: "Executable", startup: "Startup", startWithSystem: "Start with system",
  ...
  const dictionaries = {
    ...
    zh: {
      ...
      settings: {
        ...
        codex: "Codex", executable: "可执行文件", startup: "启动", startWithSystem: "随系统启动",
    ...
    ja: {
      ...
      settings: {
        ...
        codex: "Codex", executable: "実行ファイル", startup: "起動", startWithSystem: "システム起動時に開始",
    ...
    ko: {
      ...
      settings: {
        ...
        codex: "Codex", executable: "실행 파일", startup: "시작", startWithSystem: "시스템 시작 시 실행",
